...
-- ====================================================================
-- 13. MANAJEMEN PESERTA (SIMPAN / HAPUS / IMPOR)
-- ====================================================================
-- Modul Peserta mengambil data dari public.users (akun terdaftar), sedangkan
-- kamar/armada/status kehadiran disimpan sebagai data pelengkap di
-- public.participants. Pembuatan & penghapusan akun menyentuh skema `auth`,
-- sehingga wajib lewat fungsi SECURITY DEFINER berikut dan tidak dapat
-- dipanggil dengan anon key.
--
-- Berkas yang sama juga tersedia terpisah sebagai supabase/participant_management.sql
-- untuk project yang sudah berjalan dan hanya perlu menambahkan fungsi ini.
